...
class NaissancePage extends StatelessWidget {
  const NaissancePage({Key? key}) : super(key: key);
        ...
        builder: (context, model, child) => Scaffold(
                    ...
                    children: [
                      Container(
                        ...
                        child: CalendarDatePicker(
                          initialDate: (infos!.elementAt(7).toString().isEmpty)
                              ? DateTime.now()
                              : DateTime.parse(infos.elementAt(7).toString()),
              ...
              bottomSheet: Container(
                ...
                child: RoundedLoadingButton(
                  ...
                  borderRadius: 5,
                  onPressed: () async {
                    if (model.dNaissance.isNotEmpty)
                      try {
